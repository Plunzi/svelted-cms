...
<main class="max-h-screen w-full bg-neutral-900">
	<nav class="flex h-16 items-center justify-between border-b border-neutral-800 bg-neutral-950 fixed left-0 right-0 top-0 z-10">
	...
	<div class="flex mt-16">
		<nav
			class="h-full-editor fixed left-0 top-16 z-10 {client.sidebar
		...
		<section
			class="max-h-editor relative flex-1 pl-16 {overflow
				? 'overflow-y-auto'
