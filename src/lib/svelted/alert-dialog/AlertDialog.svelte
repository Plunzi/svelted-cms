<script lang="ts">
    ...
    export let description: string = "This action cannot be undone. This will permanently delete this route and remove it's data from your servers.";
</script>

<div id="popup-modal" class="opacity-0 absolute bottom-0 left-0 right-0 top-0 z-10 hidden">
	<div
	...
	>
		<div class="flex flex-col space-y-2">
			<h1 class="text-lg font-semibold text-neutral-200">{@html title}</h1>
			<p class="text-neutral-500" style="text-wrap: balance;">{description}</p>
		</div>
